return {
	...
	keys = {
		...
		{ '<leader>pi', function() require("goto-preview").goto_preview_type_implementation() end, { desc = "Preview Implementation", silent = true } },
		{ '<leader>pr', function() require("goto-preview").goto_preview_references() end,      { desc = "Preview References", silent = true } },
		{ '<leader>ps', function() require("goto-preview").goto_preview_declaration() end,      { desc = "Preview References", silent = true } },
