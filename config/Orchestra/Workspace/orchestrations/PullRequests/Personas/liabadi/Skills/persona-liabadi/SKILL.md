...
description: Use when reviewing a Pull Request and you want to apply the liabadi reviewing perspective, covering Resource Providers, RPAAS, UserRP ARM, Azure deployment and RP semantics, orchestration correctness, and observability.
version: 1.0.0
